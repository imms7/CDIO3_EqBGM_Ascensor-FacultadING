...
> 📊 **Documento Oficial:** [Dar click para observar el protocolo de pruebas](https://docs.google.com/spreadsheets/d/1Qz6l84gm7BfC-t2pQ3CDzLB2sKld-PThRO9EJB8Gyu0/edit?gid=0#gid=0)
...
| **TEST-SEG-01** | Sistema de parada | Verificar activación de seguridad | Activación correcta < **500 ms** | ✅ **PASS** |
| **TEST-MEC-02** | Sistema de desplazamiento | Evaluar vibraciones durante movimiento | Vibración moderada observada | ✅ **PASS**|
